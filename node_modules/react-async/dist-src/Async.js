...
import { Initial, Pending, Fulfilled, Rejected, Settled } from "./helpers.js";
...
export const createInstance = (defaultProps = {}, displayName = "Async") => {
  ...
  class Async extends React.Component {
    ...
    componentDidUpdate(prevProps) {
      ...
      if (watchFn && watchFn(_objectSpread({}, defaultProps, {}, this.props), _objectSpread({}, defaultProps, {}, prevProps))) {
        if (this.counter) this.cancel();
        return this.load();
      }
    ...
    load() {
      ...
      if (promiseFn) {
        const props = _objectSpread({}, defaultProps, {}, this.props);
  ...
  const AsyncInitial = props => React.createElement(Consumer, null, st => React.createElement(Initial, _extends({}, props, {
    state: st
  })));

  const AsyncPending = props => React.createElement(Consumer, null, st => React.createElement(Pending, _extends({}, props, {
    state: st
  })));

  const AsyncFulfilled = props => React.createElement(Consumer, null, st => React.createElement(Fulfilled, _extends({}, props, {
    state: st
  })));

  const AsyncRejected = props => React.createElement(Consumer, null, st => React.createElement(Rejected, _extends({}, props, {
    state: st
  })));

  const AsyncSettled = props => React.createElement(Consumer, null, st => React.createElement(Settled, _extends({}, props, {
    state: st
  })));
